...
export const SYSTEM_TEMPLATE_TOKENS: TemplateTokenDefinition[] = [
  ...
  },
  {
    ...
    key: 'bride.address',
    label: 'Bride Address',
    description: 'Bride address captured from questionnaire token mapping.',
    exampleValue: '123 Any St., Cancun, Q.R.',
    scope: 'all',
    isActive: true,
  },
  {
    ...
    key: 'groom.address',
    label: 'Groom Address',
    description: 'Groom address captured from questionnaire token mapping.',
    exampleValue: '456 Main St., Tulum, Q.R.',
    scope: 'all',
    isActive: true,
  },
  {
